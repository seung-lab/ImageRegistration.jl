...
function solveMeshSet!(Ms, match_coeff, eta_grad, grad_threshold, eta_newton, newton_threshold)
	nodes = Points(0);
	...
	SolveMesh!(nodes, nodes_fixed, edges, edge_coeffs, edge_lengths, eta_grad, grad_threshold, eta_newton, newton_threshold);
	nodes_t = Points(0);
